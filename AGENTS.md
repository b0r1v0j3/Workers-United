...
30. **🚫 NIKAKVI MEJLOVI SE NE ŠALJU DOK TIM NE KAŽE** — Sistem je u fazi pripreme. NE uključivati cron jobove, NE slati welcome emailove, NE slati announcement-e, NE slati automatske notifikacije korisnicima. Ovo važi za SVE email mehanizme: `sendEmail()`, `queueEmail()`, cron jobs, server actions koji šalju email. Čekamo eksplicitnu potvrdu od tima pre nego što se bilo koji email mehanizam aktivira.

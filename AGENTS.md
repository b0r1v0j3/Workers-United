...
- **Navbar dizajn:** `UnifiedNavbar.tsx` koristi čist public header (`h-[68px]`) sa stalnim glass efektom (`bg-white/90 backdrop-blur-md`), bez srednjih public linkova (`How it works / For Workers / For Employers`) i bez mobile hamburger menija. Dinamički scroll (bubrenje/skupljanje) je **ukinut**. 

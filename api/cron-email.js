...
const EMAIL_TEMPLATES = {
  ...
  docs_approved: (name) => ({
    ...
    body: `
      ...
      <h3>🚀 Status Update: Priority Waitlist</h3>
      <p>You have been successfully added to our candidate waitlist.</p>
      ...
      <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 25px; border-radius: 12px; text-align: center; margin: 25px 0;">
        <h2 style="margin: 0; color: white;">✅ You are on the list!</h2>
        <p style="margin: 10px 0; opacity: 0.9;">We are now matching your profile with employers.</p>
      </div>

      <h3>What Happens Next?</h3>
      <ol style="line-height: 2;">
        <li>We match you with employers seeking your skills</li>
        <li>You will receive job offers directly via email</li>
        <li>We assist with visa and relocation when you accept an offer</li>
      </ol>

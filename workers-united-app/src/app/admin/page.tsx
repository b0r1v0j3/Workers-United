        ...
        <div className="min-h-screen bg-[#f1f5f9] font-montserrat">
            ...
            <div className="max-w-[1200px] mx-auto px-5 py-10">
                <div className="mb-8 flex justify-between items-end">
                    <div>
                        <h1 className="text-3xl font-bold text-[#1e293b]">Candidate Overview</h1>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-[#f1f5f9]">
                                ...
                                {candidates?.length === 0 && (
                                    <tr>
                                        <td colSpan={5} className="px-6 py-10 text-center text-[#64748b] italic">
                                            No candidates found.
                                        </td>
                                    </tr>
                                )}
...
function RefundButton({ paymentId }: { paymentId: string }) {
    return (
        <form action={async (formData) => {
            ...
            // We can't really call markRefunded directly from here if it's a client interaction,
            // but this is a Server Component and we are defining a Server Action for the form.
            // However, paymentId in admin_candidate_summary refers to user_id, 
            // the payment record itself has a different ID.
            // Let's fix the view to include payment_id or look it up.
            // For now, I'll pass the user_id and look up the payment in the action.
            await markRefunded(paymentId, notes);
        }}>
            <button className="bg-white border border-red-200 text-red-600 px-4 py-2 rounded-lg text-[13px] font-bold hover:bg-red-50 transition-colors">
                Mark Refunded
            </button>
        </form>
    );

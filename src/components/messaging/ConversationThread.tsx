...
export default function ConversationThread({
    ...
    return (
        <div className="relative flex min-h-[560px] flex-col overflow-hidden rounded-none border-0 bg-transparent px-1 pt-5 shadow-none before:absolute before:left-3 before:right-3 before:top-0 before:h-px before:bg-[#e5e7eb] sm:rounded-[14px] sm:border sm:border-[#e7e7e5] sm:bg-white sm:px-0 sm:pt-0 sm:shadow-[0_20px_45px_-40px_rgba(15,23,42,0.28)] sm:before:hidden">
            <div className="border-b border-[#f1f1ef] px-1 py-4 sm:px-6 sm:py-5">
            ...
            <div className="flex-1 space-y-4 overflow-y-auto bg-transparent px-1 py-5 sm:bg-[#fafafa] sm:px-6 sm:py-6">
            ...
            <div className="border-t border-[#f1f1ef] bg-transparent px-1 py-5 sm:bg-white sm:px-6">
                {canSend ? (

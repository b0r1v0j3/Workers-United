    ...
    <div className="min-h-screen bg-[var(--bg)] font-montserrat">
      ...
      <footer className="bg-[#183b56] text-white py-10">
        ...
        <div className="flex justify-center gap-3 py-4">
          <a href="https://www.facebook.com/profile.php?id=61585104076725" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center text-white/70 hover:text-white transition-colors rounded-full bg-white/10 hover:bg-white/20" aria-label="Facebook">
          ...
          <a href="https://www.instagram.com/workersunited.eu/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center text-white/70 hover:text-white transition-colors rounded-full bg-white/10 hover:bg-white/20" aria-label="Instagram">
          ...
          <a href="https://www.threads.com/@workersunited.eu" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center text-white/70 hover:text-white transition-colors rounded-full bg-white/10 hover:bg-white/20" aria-label="Threads">
            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.59 12c.025 3.083.717 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.711-.108 1.752-.68 3.12-1.706 4.07-1.104 1.024-2.588 1.545-4.416 1.545h-.015c-1.986-.014-3.545-.816-4.502-2.32-.822-1.292-1.244-3.016-1.222-4.99.045-3.682 1.88-5.887 4.91-5.902h.01c1.597.008 2.86.542 3.753 1.588.463.543.796 1.2.998 1.96.59-.108 1.2-.166 1.83-.175 1.202-.017 2.252.192 3.125.624v-.004c.27.134.51.285.723.457l.002.002c1.104.894 1.695 2.2 1.695 3.598 0 2.577-1.267 4.93-3.474 6.452C16.906 23.182 14.697 23.98 12.186 24zm.053-15.774c-1.837.01-3.065 1.263-3.1 3.777-.015 1.584.278 2.88.873 3.813.566.888 1.462 1.37 2.597 1.378h.012c1.26-.014 2.24-.362 2.91-.984.74-.686 1.13-1.712 1.153-3.043.01-.072.015-.14.015-.21 0-.52-.063-1.004-.178-1.443-.328-1.255-1.096-2.047-2.284-2.353a5.478 5.478 0 0 0-1.37-.17c-.208 0-.42.012-.628.035z" /></svg>
          </a>
          <a href="https://www.linkedin.com/company/workersunited-eu/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center text-white/70 hover:text-white transition-colors rounded-full bg-white/10 hover:bg-white/20" aria-label="LinkedIn">
          ...
          <a href="https://x.com/WorkersUnitedEU" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center text-white/70 hover:text-white transition-colors rounded-full bg-white/10 hover:bg-white/20" aria-label="X">
          ...
          <a href="https://www.tiktok.com/@www.workersunited.eu" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center text-white/70 hover:text-white transition-colors rounded-full bg-white/10 hover:bg-white/20" aria-label="TikTok">
          ...
          <a href="https://www.reddit.com/r/WorkersUnitedEU/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center text-white/70 hover:text-white transition-colors rounded-full bg-white/10 hover:bg-white/20" aria-label="Reddit">

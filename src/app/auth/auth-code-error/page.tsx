            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-blue-100/80 text-lg max-w-md leading-relaxed mb-12">
                        Your confirmation link may have expired. No worries — just request a new one.
                    </p>
                </div>
                ...
                <div className="w-full max-w-[420px] pt-16 lg:pt-0">
                    ...
                    <div className="mb-8 text-center lg:text-left">
                        ...
                        <p className="text-[#64748b] font-medium leading-relaxed">
                            Your email confirmation link has expired or is invalid. Enter your email below and we&apos;ll send you a fresh one.
                        </p>
                    </div>

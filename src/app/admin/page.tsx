...
export default async function AdminDashboard() {
    ...
    const [
        ...
        admin.from("worker_onboarding").select("id, profile_id, status, queue_joined_at, admin_approved, created_at, entry_fee_paid, phone, nationality, current_country, preferred_job, gender, date_of_birth, birth_country, birth_city, citizenship, marital_status, passport_number, lives_abroad, previous_visas, family_data"),

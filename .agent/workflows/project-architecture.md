...
│   │   ├── platform-contact.ts # Client-safe canonical public URL/support-email normalization used by platform-config, email templates, WhatsApp CTA suffix handling, worker approval payloads, and admin email-preview mocks
